...
function show_sidebar() {
	arrow.setAttribute('onclick','hide_sidebar()');
	arrow.classList.add('opened_sidebar_arrow');
	sidebar.classList.remove('hidden_sidebar');
}

function hide_sidebar() {
	arrow.setAttribute('onclick','show_sidebar()');
	arrow.classList.remove('opened_sidebar_arrow');
